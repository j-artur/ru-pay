  ...
  return (
    <>
      ...
      <div className="flex w-full justify-center h-12">
        <button className="flex justify-center items-center bg-blue-500 rounded-l-lg border-2 border-blue-600 w-12">
        ...
        <button className="flex justify-center items-center bg-blue-500 rounded-r-lg border-2 border-blue-600 w-12">
          <FaAngleRight className="text-white text-4xl" />
        </button>
      </div>
      <div className="flex justify-center space-x-12 p-4">
        <button className="py-1 px-2 text-2xl flex justify-center items-center bg-blue-500 rounded border-2 border-blue-600 w-24">
          Almoço
        </button>
        <button className="py-1 px-2 text-2xl flex justify-center items-center bg-blue-500 rounded border-2 border-blue-600 w-24">
          Jantar
      ...
      <div>
        <div className="flex justify-center">
          <table className="w-full">
            <thead>
              <tr className="border-b-blue-500 border-b-4">
                <th className="text-left text-2xl">Menu</th>
                <th className="text-left text-2xl">Item</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b-blue-500 border-b-2">
